...
- What went well? I added sounds to my game
- What didn’t go well? Everything went well
- What can I improve next week? I'm going to work on making my level 


## 2. Current State (Context)
Summarize where the project stands right now (2–3 bullet points).  
-Action between player and enemies
-Game has sound
...
**Format:**  
*As an [user], I want to [make my level] so that [it looks like a real game and attracts other users to play it].*

## 4. Acceptance Criteria (Given–When–Then)
Define 1–3 testable conditions that prove your User Story is satisfied.

**Format:**  
*Given* [I make my level],  
*When* [I setup my assets],  
*Then* [my game has an environment to be played in].

## 5. Definition of Done (DoD)
Describe what it means for this sprint’s User Story to be considered complete.

**Format:**  
*The work is considered done when [I make my level].*

## 6. Blockers (as Help Requests)
Identify problems slowing or stopping your progress, framed as help requests.
- Blocker: Familiarity in Adobe Photoshop 
- Help Request: Look at tutorials in photoshop
...
-Use Adobe Photoshop to change the colors of the enemy sprite asset
-Add environment using assets
-Use photoshop to setup tiles asset in Unity


## 8. Next Steps
List the concrete, actionable tasks you will complete before the next class/report.
-Use photoshop to setup assets for my environment and change color for enemy sprite sheet
-All needed for the designing of my level
